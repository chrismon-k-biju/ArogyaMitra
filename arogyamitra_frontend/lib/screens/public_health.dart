            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildAlertItem('Dengue Outbreak', 'Ernakulam District\n45 active cases', 'HIGH', Colors.red),
                  const SizedBox(height: 12),
                  _buildAlertItem('Food Poisoning Cluster', 'Thrissur District\n12 active cases', 'MEDIUM', Colors.orange),
                  const SizedBox(height: 12),
                  _buildAlertItem('Seasonal Flu', 'Kozhikode District\n89 active cases', 'LOW', Colors.amber.shade700),
                ],
              ),
            ),
            const SizedBox(height: 24),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildActivityItem(Colors.blue, 'New health camp registered', 'Kakkanad Construction Site • 2 hours ago'),
                  const Divider(height: 24),
                  _buildActivityItem(Colors.orange, 'Dengue case reported', 'Ernakulam District • 4 hours ago'),
                  const Divider(height: 24),
                  _buildActivityItem(Colors.green, 'Vaccination milestone reached', 'Kerala State • Yesterday'),
                ],
              ),
            ),
            const SizedBox(height: 20),
